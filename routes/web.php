...
Route::get('/category/{id}', [App\Http\Controllers\HomeController::class, 'getCategory'])->name('categories');

//(ONCHANGE ROUTE FOR PINDAH)////
Route::get('old_location_space/{id}', [\App\Http\Controllers\HomeController::class, 'checkLocation']);